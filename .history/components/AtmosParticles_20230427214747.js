...
const AtmosParticles = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // renderer.setClearColor(0x000000, 1); // 改背景颜色
      ...
      window.location.href = "/other-page";
        ...
        return (
          <>
            <div
              ref={containerRef}
              // onClick={handleClick} 设置跳转其他链接
              style={{
                width: "100vw",
                height: "100vh",
                overflow: "hidden",
                position: "absolute",
                zIndex: -1,//调整图层顺序 确保粒子系统的 z-index 值低于其他页面元素。
              }}
            ></div>
           <ImageGallery />
      {/* <motion.section
      ...
      >
        ...
        />
            ...
            <motion.div
              ...
              style={{
                position: "relative",
                zIndex: 1, // 这里设置一个比粒子系统更高的z-index 所以粒子背景都会作为背景，不会覆盖当前的主要内容
              }}
            >
            ...
            <div style={{ height: "2000px" }}></div> 伸长页面，可以实现滚动闪现
